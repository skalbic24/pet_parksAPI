...
public class ParkController {
	...
	public void deleteAllContributos() {
		log.info("Attempting to delete all contributors");
		throw new UnsupportedOperationException("Deleting all contributor is not allowed");
	}
	...
	public Map<String, String> deleteContributorById(
		...
		return Map.of("message", "Deletion of contributor with ID=" + contributorId
				+ "was successful.");
	}
